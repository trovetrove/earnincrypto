...
export const metadata: Metadata = {
  title: `Crypto Tools & Airdrops ${CURRENT_YEAR} — Best Crypto Opportunities`,
  description:
    `Discover the best crypto airdrops, exchanges, DeFi yields, wallets, and trading tools for ${CURRENT_YEAR}. Curated and independently reviewed.`,
  alternates: {
    canonical: `${BASE_URL}/crypto`,
  },
  openGraph: {
    title: `Crypto Tools & Airdrops ${CURRENT_YEAR} — SideHustleTools`,
    description: `Best crypto airdrops, exchanges, DeFi yields, wallets, and trading tools. Independently reviewed for ${CURRENT_YEAR}.`,
    url: `${BASE_URL}/crypto`,
  },
};
...
export default async function CryptoHomePage() {
  ...
  const cryptoListJsonLd = {
    ...
    "@type": "CollectionPage",
    name: `Crypto Tools & Airdrops — SideHustleTools`,
          ...
          <div className="container relative z-10 mx-auto px-4">
            <div className="flex flex-col items-center text-center">
              <div className="mb-6 inline-flex items-center gap-2 border border-[#7C4DFF]/30 bg-[#7C4DFF]/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-[#7C4DFF]">
                <Sparkles className="h-3 w-3" aria-hidden="true" /> Crypto Section
              </div>
          ...
          <section className="border-t border-white/[0.06] py-14">
            <div className="container mx-auto px-4">
              <div className="mb-8 flex items-center justify-between">
                <h2 className="font-display text-2xl font-black text-white">Featured</h2>
                <Link
                  href="/crypto/directory"
